...
# Adapted from Swin-Transformer-Object-Detection for FGDC-Net teacher loading.
"""Detectron2/MMDetection-style Swin Transformer backbone."""
...
class SwinTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.ape:
            ...
            x = (x + absolute_pos_embed.flatten(2).transpose(1, 2)).contiguous()
        x = self.pos_drop(x)
        outs = {}
